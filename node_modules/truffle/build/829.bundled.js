...
function getImports({ source: { filePath, body, source }, shouldIncludePath, parseImports }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return (yield Promise.all(imports.map(dependencyPath => source.resolveDependencyPath(filePath, dependencyPath)))).filter(path => path); //filter out Vyper failures
    });
}
 ...
 */
function collectSources(originalSources, originalTargets = [], contractsDirectory = "" //only used by Vyper atm
) {
    const mappedResults = Object.entries(originalSources)
        .map(([originalSourcePath, contents]) => ({
        originalSourcePath,
        contents,
        sourcePath: getPortableSourcePath(removeRootDirectory(originalSourcePath, contractsDirectory))
    }))
...
function removeRootDirectory(sourcePath, rootDirectory) {
...
const request = __webpack_require__(908037);
const fs = __webpack_require__(935747);
...
exports.getInitialConfig = ({ truffleDirectory, workingDirectory, network }) => {
...
exports.configProps = ({ configObject }) => {
...
"use strict";
module.exports = JSON.parse("{\"name\":\"@truffle/core\",\"description\":\"Core code for Truffle command line tool\",\"author\":\"consensys.net\",\"homepage\":\"https://github.com/trufflesuite/truffle#readme\",\"repository\":\"https://github.com/trufflesuite/truffle/tree/master/packages/core\",\"bugs\":{\"url\":\"https://github.com/trufflesuite/truffle/issues\"},\"version\":\"5.3.2\",\"bin\":{\"truffle\":\"./cli.js\",\"truffle-exec\":\"./exec.js\"},\"scripts\":{\"prepare\":\"exit 0\",\"test\":\"mocha ./test/** ./test/**/*\"},\"dependencies\":{\"@truffle/artifactor\":\"^4.0.101\",\"@truffle/box\":\"^2.1.8\",\"@truffle/codec\":\"^0.10.3\",\"@truffle/compile-solidity\":\"^5.2.5\",\"@truffle/config\":\"^1.2.37\",\"@truffle/contract\":\"^4.3.13\",\"@truffle/contract-sources\":\"^0.1.11\",\"@truffle/debug-utils\":\"^5.0.13\",\"@truffle/debugger\":\"^8.0.21\",\"@truffle/decoder\":\"^4.5.8\",\"@truffle/deployer\":\"^3.2.20\",\"@truffle/environment\":\"^0.2.50\",\"@truffle/error\":\"^0.0.12\",\"@truffle/expect\":\"^0.0.15\",\"@truffle/interface-adapter\":\"^0.4.21\",\"@truffle/migrate\":\"^3.2.20\",\"@truffle/plugins\":\"^0.2.0\",\"@truffle/preserve\":\"^0.2.0\",\"@truffle/preserve-fs\":\"^0.2.0\",\"@truffle/preserve-to-buckets\":\"^0.2.0\",\"@truffle/preserve-to-filecoin\":\"^0.2.0\",\"@truffle/preserve-to-ipfs\":\"^0.2.0\",\"@truffle/provider\":\"^0.2.28\",\"@truffle/provisioner\":\"^0.2.15\",\"@truffle/require\":\"^2.0.60\",\"@truffle/resolver\":\"^7.0.7\",\"@truffle/source-fetcher\":\"^0.3.6\",\"@truffle/workflow-compile\":\"^3.2.6\",\"app-module-path\":\"^2.2.0\",\"chai\":\"^4.2.0\",\"colors\":\"^1.4.0\",\"command-exists\":\"^1.2.8\",\"configstore\":\"^4.0.0\",\"cpr\":\"^3.0.1\",\"debug\":\"^4.3.1\",\"del\":\"^2.2.0\",\"ethereum-cryptography\":\"^0.1.3\",\"ethereumjs-wallet\":\"^1.0.1\",\"ethpm\":\"0.0.19\",\"ethpm-registry\":\"0.1.0-next.3\",\"fs-extra\":\"^9.1.0\",\"ganache-core\":\"2.13.0\",\"get-port\":\"^5.1.1\",\"glob\":\"^7.1.6\",\"hdkey\":\"^1.1.0\",\"js-interpreter\":\"2.2.0\",\"mocha\":\"8.1.2\",\"node-emoji\":\"^1.8.1\",\"node-ipc\":\"^9.1.1\",\"ora\":\"^3.4.0\",\"original-require\":\"^1.0.1\",\"sane\":\"^4.0.2\",\"semver\":\"^7.3.4\",\"source-map-support\":\"^0.5.19\",\"spawn-args\":\"^0.1.0\",\"tmp\":\"^0.2.1\",\"universal-analytics\":\"^0.4.17\",\"web3\":\"1.3.5\",\"web3-utils\":\"1.3.5\",\"xregexp\":\"^4.2.4\",\"yargs\":\"^8.0.2\"},\"devDependencies\":{\"@truffle/blockchain-utils\":\"^0.0.28\",\"chai-as-promised\":\"^7.1.1\",\"memorystream\":\"^0.3.1\"},\"publishConfig\":{\"access\":\"public\"},\"authors\":[{\"name\":\"Tim Coulter\",\"email\":\"tim@trufflesuite.com\",\"url\":\"https://github.com/tcoulter\"}],\"namespace\":\"consensys\",\"gitHead\":\"8a131455e99ca67106e01f6aa43dc24515737d38\"}");
